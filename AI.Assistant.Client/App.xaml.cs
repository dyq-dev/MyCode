        ...
        _host = Host.CreateDefaultBuilder()
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<MainViewModel>(sp =>
                {
                    ...
                    var ragService = (RagChatService)sp.GetRequiredService<IChatService>();
                    var convStore = sp.GetRequiredService<IConversationStore>();
                    var memory = sp.GetService<MemoryService>();
                    return new MainViewModel(chatService, workspace, parsers, knowledgeStore, indexer, ragService, convStore, memory, isDevMode);
                });
